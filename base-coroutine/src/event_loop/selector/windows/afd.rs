...
use windows_sys::Win32::{
    Foundation::{INVALID_HANDLE_VALUE, UNICODE_STRING},
    Storage::FileSystem::{
        NtCreateFile, SetFileCompletionNotificationModes, FILE_OPEN, FILE_SHARE_READ,
        FILE_SHARE_WRITE, SYNCHRONIZE,
    },
    System::WindowsProgramming::{FILE_SKIP_SET_EVENT_ON_HANDLE, OBJECT_ATTRIBUTES},
};
...
const AFD_HELPER_NAME: &[u16] = &[
    ...
    'f' as _, 'd' as _, '\\' as _, 'M' as _, 'i' as _, 'o' as _,
];
